...
namespace Rbt.Log
{
    ...
    public class Bitacora
    {
        ...
        private static string destinatario = ConfigurationManager.AppSettings["CORREO_OPERACIONES"].ToString();
        private static string CorreoDe = ConfigurationManager.AppSettings["CORREO_APLICATIVO"];
        private static string AsuntoErrores = ConfigurationManager.AppSettings["CABECERA_ERROR"];
        ...
        protected static void configuracion()
        {
            ...
            fileTarget.FileName = (Layout)(ConfigurationManager.AppSettings["DirecDailyLogs"].ToString() + ".txt");
            fileTarget.Layout = (Layout)ConfigurationManager.AppSettings["LayoutNlog"].ToString();
        ...
        public static void LogInformacion(Logger logger, string descripcion)
        {
            ...
            {
               Bitacora.RegistroErrorLogEmail("ERROR. Envio de la Informacion ", ex); 
            }
        }
        ...
        public static void LogAdvertencia(Logger logger, string descripcion)
        {
            ...
            {
                Bitacora.RegistroErrorLogEmail("ERROR. Error en envio de la Advertencia ", ex);
            }
        }
        ...
        public static void LogError(Logger logger, string descripcion, Exception error)
        {
            ...
            {
                Bitacora.RegistroErrorLogEmail("ERROR. Envio de mensaje de Error ", ex);
            }
        }

        public static void Enviarmails(string para, string asunto, string cuerpo)
        {
            MailMessage message = new MailMessage();
            message.From = new MailAddress(CorreoDe);
        ...
        public static void registroTXT(string contenido)
        {
            ...
            {
                throw new Exception(MethodBase.GetCurrentMethod() + "-->" + ex.ToString());
            }

        }


        public static void Enviarmails3(string para, string de, string asunto, string cuerpo, string ServidorCorreo)
        {
            //Armado del correo
            System.Net.Mail.MailMessage correo = new System.Net.Mail.MailMessage();
            correo.From = new System.Net.Mail.MailAddress(de);
