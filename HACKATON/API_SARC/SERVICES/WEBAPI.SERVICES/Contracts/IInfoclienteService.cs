...
namespace WEBAPI.SERVICES.Contracts
{
    public interface IInfoclienteService
    {
        ...
        Task<ServiceResponse<List<GetClienteResponse>>> GetClientePjByIdcAsync(GetClientByIdcRequest request, string matricula, string requestId);
        Task<ServiceResponse<List<GetClienteResponse>>> GetClientePnByDbcAsync(GetClientByDbcRequest request, string requestId);
        Task<ServiceResponse<List<GetClienteResponse>>> GetClientePjByDbcAsync(GetClientByDbcRequest request, string requestId);
